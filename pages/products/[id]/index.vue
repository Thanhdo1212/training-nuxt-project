...
<template>
  <v-app>
    <v-app-bar>
      <v-app-bar-nav-icon @click="navigateBack">
...
const isInStock = ref(true); // Mock data, in a real app this would come from your API
...
const addToCart = () => {
  ...
  // Giả lập quá trình thêm vào giỏ hàng
  setTimeout(() => {
